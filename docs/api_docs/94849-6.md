...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94849](https://developer.work.weixin.qq.com/document/path/94849)
- **文档 ID**: `94849`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/export/simple_user?access_token=ACCESS_TOKEN`
