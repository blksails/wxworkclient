# 获取打卡月报数据 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/93387](https://developer.work.weixin.qq.com/document/path/93387)
- **文档 ID**: `93387`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/checkin/getcheckin_monthdata?access_token=ACCESS_TOKEN`
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| access_token | string | 是 | 调用接口凭证，使用自建应用的Secret获取access_token，获取方式参考：文档-获取access_token |
| starttime | uint32 | 是 | 获取月报的开始时间。0点Unix时间戳 |
| endtime | uint32 | 是 | 获取月报的结束时间。0点Unix时间戳 |
| useridlist | string[] | 是 | -不少于1字节不多于64字节可填充个数：1 ~ 100 |
...
```json
{"starttime":1599062400,"endtime":1599408000,"useridlist":["ZhangSan"]}
```
...
```json
{"errcode":0,"errmsg":"ok","datas":[{"base_info":{"record_type":1,"name":"张三","name_ex":"Three Zhang","departs_name":"有家企业/realempty;有家企业;有家企业/部门A4","rule_info":{"groupid":10,"groupname":"规则测试"},"acctid":"ZhangSan"},"summary_info":{"except_days":3,"regular_work_sec":31,"standard_work_sec":29040,"work_days":3,"rest_days":0},"exception_infos":[{"count":2,"duration":28920,"exception":4},{"count":1,"duration":60,"exception":1},{"count":1,"duration":60,"exception":2}],"sp_items":[{"count":0,"duration":0,"time_type":0,"type":100,"vacation_id":0,"name":"外勤次数"},{"count":1,"duration":0,"time_type":0,"type":1,"vacation_id":2,"name":"年假"}],"overwork_info":{"workday_over_sec":54000,"restdays_over_sec":205560,"workdays_over_as_vacation":0,"workdays_over_as_money":54000,"restdays_over_as_vacation":0,"restdays_over_as_money":172800,"holidays_over_as_vacation":0,"holidays_over_as_money":0}}]}
```
