...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94851](https://developer.work.weixin.qq.com/document/path/94851)
- **文档 ID**: `94851`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/export/user?access_token=ACCESS_TOKEN`
...
```json
{"errcode":0,"errmsg":"ok","jobid":"jobid_xxxxxxxxxxxxxxx"}
```
