# 获取「客户数据统计」接待人员明细数据 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/96433](https://developer.work.weixin.qq.com/document/path/96433)
- **文档 ID**: `96433`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/kf/get_servicer_statistic?access_token=ACCESS_TOKEN`
