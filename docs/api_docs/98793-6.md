# 获取Rooms会议室详情 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/98793](https://developer.work.weixin.qq.com/document/path/98793)
- **文档 ID**: `98793`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/meeting/rooms/get_info?access_token=ACCESS_TOKEN`
...
| pmi_code | string | 否 | Rooms会议室专属 ID |
| pmi_pwd | string | 否 | 入会密码（base64） |
...
| monitor_status | uint32 | 告警通知状态：0：未开启1：已开启 |
