...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94688](https://developer.work.weixin.qq.com/document/path/94688)
- **文档 ID**: `94688`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/kf/account/add`
