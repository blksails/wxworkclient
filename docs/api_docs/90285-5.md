...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/90285](https://developer.work.weixin.qq.com/document/path/90285)
- **文档 ID**: `90285`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/card/invoice/reimburse/updateinvoicestatus?access_token=ACCESS_TOKEN`
