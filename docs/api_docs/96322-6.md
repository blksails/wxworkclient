...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/96322](https://developer.work.weixin.qq.com/document/path/96322)
- **文档 ID**: `96322`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/externalcontact/mark_tag`
