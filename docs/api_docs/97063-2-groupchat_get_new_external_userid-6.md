...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/97063](https://developer.work.weixin.qq.com/document/path/97063)
- **文档 ID**: `97063`
- **API 名称**: `groupchat_get_new_external_userid`
- **请求方法**: `POST`
