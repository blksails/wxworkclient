...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/90980](https://developer.work.weixin.qq.com/document/path/90980)
- **文档 ID**: `90980`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/batch/syncuser?access_token=ACCESS_TOKEN`
