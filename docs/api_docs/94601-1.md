# 深色模式适配指南 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94601](https://developer.work.weixin.qq.com/document/path/94601)
- **文档 ID**: `94601`
...
```json
if(/ColorScheme\/Dark/i.test(navigator.userAgent)){/* Dark Mode Logic */}
```

#### 示例 3: 2 如何识别深色模式

```text
<bodydata-color-mode="dark">
```
...
企业微信 iOS、Android 客户端 3.1.8 版本开始支持深色模式。开发者可以通过 CSS 媒体查询prefers-color-scheme: dark来识别并对深色模式进行样式兼容。
@media(prefers-color-scheme:dark){/* Dark Mode Styles */}
