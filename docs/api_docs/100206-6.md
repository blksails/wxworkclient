...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/100206](https://developer.work.weixin.qq.com/document/path/100206)
- **文档 ID**: `100206`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/wedoc/smartsheet/delete_records`
