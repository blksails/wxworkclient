...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/97073](https://developer.work.weixin.qq.com/document/path/97073)
- **文档 ID**: `97073`
- **请求方法**: `GET`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/get_api_domain_ip`
