...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94695](https://developer.work.weixin.qq.com/document/path/94695)
- **文档 ID**: `94695`
- **请求方法**: `POST`
...
| userid_list | array | 否 | 接待人员userid列表。第三方应用填密文userid，即open_userid 可填充个数：0 ~ 100。超过100个需分批调用。 |
| department_id_list | array | 否 | 接待人员部门id列表 可填充个数：0 ~ 20。 |
...
| result_list.department_id | int32 | 接待人员部门的id |
| result_list.errcode | int32 | 该userid的添加结果 |
