...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/99368](https://developer.work.weixin.qq.com/document/path/99368)
- **文档 ID**: `99368`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/kf/account/list`
...
offset (uint32) - 分页，偏移量，默认为0
limit (uint32) - 分页，预期请求的数据量，默认为100，取值范围 1 ~ 100
