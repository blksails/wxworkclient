...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94211](https://developer.work.weixin.qq.com/document/path/94211)
- **文档 ID**: `94211`
- **请求方法**: `GET`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/oa/vacation/getcorpconf`
...
| lists.quota_attr | object | 假期发放相关配置 |
...
| lists.quota_attr.quota_rules | object | 额度计算规则，自动按年发放时有效 |
| lists.quota_attr.quota_rules.list | object[] | 额度计算规则区间，只有在选择了按照工龄计算或者按照司龄计算时有效 |
...
| lists.expire_rule | object | 假期过期规则 |
...
| lists.expire_rule.date | object | 失效日期，只有按固定时间过期时有效 |
...
| lists.expire_rule.extern_duration | object | 延长有效期的具体时间，只有在extern_duration_enable为true时有效 |
