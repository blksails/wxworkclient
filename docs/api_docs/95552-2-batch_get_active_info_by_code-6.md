...
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/license/batch_get_active_info_by_code?provider_access_token=ACCESS_TOKEN`
- **分组信息**: 第 2 个接口，共 2 个
...
| active_info_list.type | int32 | 账号类型 |
| active_info_list.status | int32 | 账号状态 |
| active_info_list.userid | string | 账号绑定激活的企业成员userid |
| active_info_list.create_time | int32 | 创建时间 |
| active_info_list.active_time | int32 | 首次激活绑定用户的时间 |
| active_info_list.expire_time | int32 | 过期时间 |
| active_info_list.merge_info | object | 合并信息 |
| active_info_list.share_info | object | 分配信息 |
