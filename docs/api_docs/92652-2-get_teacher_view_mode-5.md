...
- **文档 ID**: `92652`
- **API 名称**: `get_teacher_view_mode`
- **请求方法**: `GET`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/school/get_teacher_view_mode`
- **分组信息**: 第 2 个接口，共 2 个
...
| view_mode | int32 | 查看模式, 1-全部班级, 2-仅负责范围内的班级 |
