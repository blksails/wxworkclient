...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/90215](https://developer.work.weixin.qq.com/document/path/90215)
- **文档 ID**: `90215`
- **请求方法**: `POST`
...
请求方式：POST（HTTPS）请求地址：https://qyapi.weixin.qq.com/cgi-bin/tag/deltagusers?access_token=ACCESS_TOKEN
...
```json
{"tagid":12,"userlist":["user1","user2"],"partylist":[2,4]}
```
