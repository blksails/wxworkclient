...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/97948](https://developer.work.weixin.qq.com/document/path/97948)
- **文档 ID**: `97948`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/wedrive/space_setting`
