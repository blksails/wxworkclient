...
- **API 名称**: `update_link`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/externalcontact/customer_acquisition/update_link`
- **分组信息**: 第 4 个接口，共 5 个
...
| range.user_list | array | 否 | 此获客链接关联的userid列表，最多可关联500个 |
...
| priority_option.priority_userid_list | array | 否 | priority_type为2时的指定成员列表，最多1000个 |
