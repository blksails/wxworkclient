...
- **文档 ID**: `99996`
- **API 名称**: `unauth_knowledge_base`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/chatdata/unauth_knowledge_base`
- **分组信息**: 第 2 个接口，共 4 个

## 接口描述

当企业取消授权知识集时，企业微信服务器会向该知识集授权应用关联的程序推送消息。
