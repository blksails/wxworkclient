...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/99837](https://developer.work.weixin.qq.com/document/path/99837)
- **文档 ID**: `99837`
...
可调用本接口对每条会话内容进行反垃圾分析。该接口仅支持分析文本、语音、音频存档消息。
