# 获取汇报统计数据 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/93395](https://developer.work.weixin.qq.com/document/path/93395)
- **文档 ID**: `93395`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/oa/journal/get_stat_list?access_token=ACCESS_TOKEN`
...
| template_id | string | 是 | 汇报表单id,不多于256字节 |
| starttime | uint64 | 是 | 开始时间 |
| endtime | uint64 | 是 | 结束时间，时间区间最大长度为一年 |
...
```json
{"template_id":"3TmALk1ogfgKiQE3e3jRwnTUhMTh8vca1N8zUVNUx","starttime":1604160000,"endtime":1606363092}
```
