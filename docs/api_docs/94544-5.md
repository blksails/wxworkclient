...
- **文档 ID**: `94544`
- **请求方法**: `POST`
- **接口地址**: `https://wx.qy.createCorpGroupChat`
...
| corpGroupUserIds.userId | String | 否 | 企业互联/上下游企业成员userId, 仅自建应用使用 |
| corpGroupUserIds.openUserId | String | 否 | 企业互联/上下游企业成员openUserId，仅第三方应用使用 |
