# 获取员工打卡规则 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/99443](https://developer.work.weixin.qq.com/document/path/99443)
- **文档 ID**: `99443`
- **请求方法**: `POST`
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| access_token |  | 是 | 调用接口凭证。获取方式参考：文档-获取access_token须为有打卡权限的自建应用、第三方应用或代开发应用 |
...
```json
{"datetime":1511971200,"useridlist":["james","paul"]}
```
