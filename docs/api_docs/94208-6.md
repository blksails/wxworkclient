...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/94208](https://developer.work.weixin.qq.com/document/path/94208)
- **文档 ID**: `94208`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/checkin/getcheckinschedulist`
...
| schedule_list[].schedule | object | 个人排班信息 |
| schedule_list[].schedule.scheduleList | object[] | 个人排班表信息 |
| schedule_list[].schedule.scheduleList.day | uint32 | 排班日期，为表示当月第几天的数字 |
| schedule_list[].schedule.scheduleList.schedule_info | object | 个人当日排班信息 |
...
| schedule_list[].schedule.scheduleList.schedule_info.time_section | object[] | 班次上下班时段信息 |
