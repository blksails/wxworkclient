...
- **文档地址**: [https://developer.work.weixin.qq.com/document/path/100033](https://developer.work.weixin.qq.com/document/path/100033)
- **文档 ID**: `100033`
- **API 名称**: `create_summary_task`
- **请求方法**: `POST`
- **接口地址**: `create_summary_task`
- **分组信息**: 第 1 个接口，共 2 个
