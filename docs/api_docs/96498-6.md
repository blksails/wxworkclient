# 获取打卡日报数据 - 文档 - 企业微信开发者中心

## 基本信息

- **文档地址**: [https://developer.work.weixin.qq.com/document/path/96498](https://developer.work.weixin.qq.com/document/path/96498)
- **文档 ID**: `96498`
- **请求方法**: `POST`
- **接口地址**: `https://qyapi.weixin.qq.com/cgi-bin/checkin/getcheckin_daydata?access_token=ACCESS_TOKEN`
...
| useridlist | string[] | 是 | 获取日报的userid列表。单个userid不少于1字节，不多于64字节可填充个数：1 ~ 100 |
...
```json
{"starttime":1599062400,"endtime":1599062400,"useridlist":["ZhangSan"]}
```
